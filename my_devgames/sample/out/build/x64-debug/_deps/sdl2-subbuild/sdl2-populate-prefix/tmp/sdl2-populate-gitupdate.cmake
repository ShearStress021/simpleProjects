...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "release-2.30.9"
  WORKING_DIRECTORY "E:/projects/simpleProjects/my_devgames/SDL_Sample/out/build/x64-debug/_deps/sdl2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/projects/simpleProjects/my_devgames/SDL_Sample/out/build/x64-debug/_deps/sdl2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/projects/simpleProjects/my_devgames/SDL_Sample/out/build/x64-debug/_deps/sdl2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
